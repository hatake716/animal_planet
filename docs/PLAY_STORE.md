...
- **プレビュー動画**: `dist/play-v1.0.3/promo_1080x1920.mp4`(29.8 秒 / 縦型)。YouTube にアップロードして URL を登録する(手順は `docs/play/VIDEO.md`)。
...
- [ ] プレビュー動画を YouTube に公開(収益化オフ・年齢制限なし・埋め込み許可)し、URL を登録
