...
リアルな 3D 地球儀の上に、IUCN レッドリストで絶滅のおそれがあると評価された動物 1,063 種(CR 239 / EN 375 / VU 449。哺乳類 286・鳥類 311・爬虫類 181・両生類 44・魚類 210・無脊椎動物 31)を
...
### 種の詳細
- ピンをタップすると、写真(タップで全画面・ピンチ拡大)、IUCN カテゴリ(CR / EN / VU)、分類(目・科)、学名、代表的な生息地、生息地域、解説・生息環境・主な脅威、写真の作者・ライセンス(Wikimedia Commons)を詳細カードに表示。カードは「∨」で折りたためます。
...
## データと出典
- **写真**(1,009 種): Wikimedia Commons の自由ライセンス画像(CC0 / パブリックドメイン / CC BY / CC BY-SA)のみ。作者とライセンスは各写真と「写真の出典一覧」に表示。
